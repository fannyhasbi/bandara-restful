...
if(isset($_POST['tambah'])){
  if(isset($_POST['tujuan']) && isset($_POST['tanggal']) && isset($_POST['waktu']) && isset($_POST['pesawat']) && isset($_POST['penumpang'])){
    ...
    $q = "UPDATE takeoff SET tujuan = '". $t ."', waktu = '". $waktu ."', kode_pesawat = '". $p ."', penumpang = ". $n ." WHERE id_to = ". $_POST['kode_awal'];
...
$qu = "SELECT * FROM takeoff WHERE id_to = '". $kode ."'";
    ...
    <form action="" method="post">
      ...
      <div class="form-group">
        ...
        <select name="tujuan" class="form-control" required>
          ...
          ?>
            <option value="<?= $r['kode_bandara']; ?>" <?php if($ro['tujuan'] == $r['kode_bandara']){ echo " selected";}?>><?= $r['nama']; ?></option>
          <?php
          }
          ?>
        </select>
